...
@doc raw"""
    get_geometry(form::FS) where {FS <: AbstractFormExpression{manifold_dim, form_rank, G}} where {manifold_dim, form_rank, G <: Geometry.AbstractGeometry{manifold_dim}}
...
"""
function get_geometry(form::FS) where {FS <: AbstractFormExpression{manifold_dim, form_rank, G}} where {manifold_dim, form_rank, G <: Geometry.AbstractGeometry{manifold_dim}}
    return form.geometry
end

@doc raw"""
    get_geometry(form_1::FS1, form_2::FS2) where {FS1 <: AbstractFormExpression{manifold_dim1, form_rank1, G1}, FS2 <: AbstractFormExpression{manifold_dim2, form_rank2, G2}} where {manifold_dim1, form_rank1, G1 <: Geometry.AbstractGeometry{manifold_dim1}, manifold_dim2, form_rank2, G2 <: Geometry.AbstractGeometry{manifold_dim2}}
