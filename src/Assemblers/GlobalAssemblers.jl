...
function assemble(
    weak_form::Function,
    weak_form_inputs::AbstractInputs,
    ...
    nvals_A = 15 * nnz_elem[1] * get_num_quadrature_elements(weak_form_inputs)  # 4 times due to the forms being per component. This needs to be updated.
