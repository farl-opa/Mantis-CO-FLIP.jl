#!/bin/bash
#SBATCH --job-name=coflip_taylor_green
#SBATCH --partition=compute-p1
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=12
#SBATCH --mem-per-cpu=3900M
#SBATCH --time=15:00:00
#SBATCH --output=coflip_taylor_green_%j.out 
#SBATCH --error=coflip_taylor_green_%j.err
...
export OUTPUT_DIR=/scratch/opelegriartola/coflip_outputs/taylor_green_$SLURM_JOB_ID
...
# Run the simulation
julia --project=. CO-FLIP/delftblue_cases/CO-FLIP_periodic_taylor_green.jl
