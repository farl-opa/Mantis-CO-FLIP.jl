#!/bin/bash
#SBATCH --job-name=coflip_shear
#SBATCH --partition=compute-p1
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=4
#SBATCH --mem-per-cpu=3G
#SBATCH --time=15:00:00
#SBATCH --output=coflip_shear_%j.out 
#SBATCH --error=coflip_shear_%j.err
...
export OUTPUT_DIR=/scratch/opelegriartola/coflip_outputs/shear_$SLURM_JOB_ID
...
# Run the simulation
julia --project=. CO-FLIP/delftblue_cases/CO-FLIP_periodic_shear.jl
