#!/bin/bash
#SBATCH --job-name=coflip_convecting
...
export OUTPUT_DIR=/scratch/opelegriartola/coflip_outputs/convecting_$SLURM_JOB_ID
...
# Run the simulation
julia --project=. CO-FLIP/delftblue_cases/CO-FLIP_periodic_convecting.jl
