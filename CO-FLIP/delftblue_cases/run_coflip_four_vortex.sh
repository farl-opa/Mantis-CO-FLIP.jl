#!/bin/bash
#SBATCH --job-name=coflip_four_vortex
#SBATCH --partition=compute-p1
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=12
#SBATCH --mem-per-cpu=3900M
#SBATCH --time=15:00:00
#SBATCH --output=coflip_four_vortex_%j.out 
#SBATCH --error=coflip_four_vortex_%j.err
...
export OUTPUT_DIR=/scratch/opelegriartola/coflip_outputs/four_vortex_$SLURM_JOB_ID
...
# Run the simulation
julia --project=. CO-FLIP/delftblue_cases/CO-FLIP_periodic_four_vortex.jl
