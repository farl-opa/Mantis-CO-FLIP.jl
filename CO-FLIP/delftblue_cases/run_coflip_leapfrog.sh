...
export OUTPUT_DIR=/scratch/opelegriartola/coflip_outputs/leapfrog_$SLURM_JOB_ID
...
# Run the simulation
julia --project=. CO-FLIP/delftblue_cases/CO-FLIP_periodic_leapfrog.jl
