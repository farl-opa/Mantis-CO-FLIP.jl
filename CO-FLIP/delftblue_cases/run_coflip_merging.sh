#!/bin/bash
#SBATCH --job-name=coflip_merging
#SBATCH --partition=compute-p1
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=4
#SBATCH --mem-per-cpu=3G
#SBATCH --time=15:00:00
#SBATCH --output=coflip_merging_%j.out 
#SBATCH --error=coflip_merging_%j.err
...
export OUTPUT_DIR=/scratch/opelegriartola/coflip_outputs/merging_$SLURM_JOB_ID
...
# Run the simulation
julia --project=. CO-FLIP/delftblue_cases/CO-FLIP_periodic_merging.jl
