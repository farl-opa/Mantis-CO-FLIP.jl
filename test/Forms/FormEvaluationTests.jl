...
geo_2d_cart = Mantis.Geometry.create_cartesian_box(
    starting_point_2d, box_size_2d, num_elements_2d
)

# Setup the form spaces
TP_Space_2d = Mantis.FunctionSpaces.create_bspline_space(
...
zero_form_space_2d = Mantis.Forms.FormSpace(0, geo_2d_cart, TP_Space_2d, "ν")
one_form_space_2d = Mantis.Forms.FormSpace(1, geo_2d_cart, dsTP_1_form_2d, "η")
top_form_space_2d = Mantis.Forms.FormSpace(2, geo_2d_cart, TP_Space_2d, "σ")

# Checks if incorrect arguments throw errors
@test_throws ArgumentError Mantis.Forms.FormSpace(1, geo_2d_cart, TP_Space_2d, "ν")
...
# 0-forms
zero_form_space_eval, zero_form_space_idx = Mantis.Forms.evaluate(
    zero_form_space_2d, element_idx, ξ_evaluation
)

# Test output
n_active_basis_0_form = Mantis.FunctionSpaces.get_num_basis(TP_Space_2d, element_idx)
...
# 1-forms
one_form_space_eval, one_form_space_idx = Mantis.Forms.evaluate(
...
# top-forms
top_form_space_eval, top_form_space_idx = Mantis.Forms.evaluate(
    top_form_space_2d, element_idx, ξ_evaluation
)

# Test output
n_active_basis_top_form = Mantis.FunctionSpaces.get_num_basis(TP_Space_2d, element_idx)
...
# 0-forms
d_zero_form_space_2d = Mantis.Forms.ExteriorDerivative(zero_form_space_2d)
d_zero_form_space_eval, d_zero_form_space_idx = Mantis.Forms.evaluate(
...
# 1-forms
d_one_form_space_2d = Mantis.Forms.ExteriorDerivative(one_form_space_2d)
d_one_form_space_eval, d_one_form_space_idx = Mantis.Forms.evaluate(
...
# top-forms
@test_throws ArgumentError Mantis.Forms.ExteriorDerivative(top_form_space_2d)

# hodge_zero_form_space_eval, hodge_zero_form_space_idx = Mantis.Forms.evaluate_hodge_star(zero_form_space, 1, ([0.0, 1.0], [0.0, 1.0]))

# d_one_form_space_eval, d_one_form_space_idx = Mantis.Forms.evaluate(one_form_space, 1, ([0.0, 1.0], [0.0, 1.0]))
...
geo_3d_cart = Mantis.Geometry.create_cartesian_box(
...
TP_Space_3d = Mantis.FunctionSpaces.create_bspline_space(
...
# 2-forms
two_form_space_eval, two_form_space_idx = Mantis.Forms.evaluate(
...
# 0-forms
d_zero_form_space_3d = Mantis.Forms.ExteriorDerivative(zero_form_space_3d)
d_zero_form_space_eval, d_zero_form_space_idx = Mantis.Forms.evaluate(
...
# 1-forms
d_one_form_space_3d = Mantis.Forms.ExteriorDerivative(one_form_space_3d)
d_one_form_space_eval, d_one_form_space_idx = Mantis.Forms.evaluate(
...
# 2-forms
d_two_form_space_3d = Mantis.Forms.ExteriorDerivative(two_form_space_3d)
d_two_form_space_eval, d_two_form_space_idx = Mantis.Forms.evaluate(
