...
for p in range(2, 20; step=3)
    ...
    @test Quadrature.get_label(quad_rule) == "Clenshaw-Curtis"
    ...
    @test_throws DomainError Quadrature.clenshaw_curtis(1)
    @test_throws DomainError Quadrature.clenshaw_curtis(0)
    @test_throws DomainError Quadrature.clenshaw_curtis(-1)
