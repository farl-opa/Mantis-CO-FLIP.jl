...
function write_data(sub_dir::String, file_name::String, data)
    ...
    file_path = Mantis.GeneralHelpers.export_path([output_directory_tree; sub_dir], file_name)
...
function read_data(sub_dir::String, file_name::String)
    ...
    file_path = Mantis.GeneralHelpers.export_path([reference_directory_tree; sub_dir], file_name)
