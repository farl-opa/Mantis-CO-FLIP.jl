...
{ return std::min(std::min(a1, a2), std::min(a3, a4), a5); }

template<class T>
inline T min(T a1, T a2, T a3, T a4, T a5, T a6)
{ return std::min(std::min(a1, a2), std::min(a3, a4), std::min(a5, a6)); }
...
{ return std::max(std::max(a1, a2), std::max(a3, a4),  a5); }

template<class T>
inline T max(T a1, T a2, T a3, T a4, T a5, T a6)
{ return std::max(std::max(a1, a2), std::max(a3, a4),  std::max(a5, a6)); }
